...
fun NotesScreen(viewModel: MainViewModel) {
    ...
    val scaffoldState: ScaffoldState = rememberScaffoldState() //จำสถานะของ scaffold เราว่่าเราเปิดปิดอะไรอยู่
    val coroutineScope = rememberCoroutineScope() // ใช้เรียก coroutine เป็น function เป็น background
    ...
    Scaffold(
        ...
        drawerContent = {
            AppDrawer(
                ...
                coroutineScope.launch { // เรียกเป็น background
